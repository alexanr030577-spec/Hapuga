...
class HuntService : Service() {
    companion object {
        ...
        const val ACTION_NEW_ORDER="ru.hapuga.NEW_ORDER"; const val ACTION_ORDER_DETECTED_EXTERNAL="ru.hapuga.ORDER_DETECTED"; const val ACTION_DIAGNOSTIC="ru.hapuga.DIAGNOSTIC"
